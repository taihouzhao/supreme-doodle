...
| 项目 | 包名 | 状态 | 试玩 |
|------|------|------|------|
| [决战朝鲜](./apps/korea-tactics/) | `@dashjie/korea-tactics` | 可玩 | https://supreme-doodle.dashjie.net/index.html |
| [金庸群侠传](./apps/jinyong-heroes/) | `@dashjie/jinyong-heroes` | 《连城诀》攻略重建（未导入原版） | https://supreme-doodle.dashjie.net/jinyong-heroes/index.html |
| [决战朝鲜：塔防](./apps/korea-defense/) | `@dashjie/korea-defense` | 温井防御战垂直切片 | https://supreme-doodle.dashjie.net/korea-defense/ |
| [虚构卫星地图](./apps/city-map/) | `@dashjie/city-map` | 程序化城市俯瞰 | https://supreme-doodle.dashjie.net/map/ |
| [游戏目录](./apps/studio-site/) | `@dashjie/studio-site` | 索引页 | https://supreme-doodle.dashjie.net/games/index.html |

...
export const HISTORICAL_MISSIONS: MissionConfig[] = [
  {
    ...
    mapNote: "北在上；两侧峭壁夹出两水洞峡谷，中央是温井—北镇公路，伏击线在谷底，温井是南端村镇，九龙江沿南缘切断迂回。",
  ...
  },
  {
    ...
    mapNote: "北在上；道路由西北柳潭里斜向东南下碣隅里，长津湖占据整个东侧；西缘是不可攀的山壁，两处目标是主补给路沿线临时路障。",
  ...
  },
  {
    ...
    mapNote: "村镇与连续堡垒环代表砥平里防御圈；北侧整行开阔地是脱离地域，南侧道路是克伦贝装甲特遣队解围方向。",
    weather: { options: ["snow", "overcast"], label: "残雪与低云", detail: "夜间寒冷，天亮后能见度逐步改善。" },
    playerEquipment: PVA_EARLY,
    // 自适应难度抬升后，砥平里撤离关需要更低底伤以免死种子。

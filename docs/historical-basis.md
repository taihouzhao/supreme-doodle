...
本项目不是军史仿真器。每个棋盘把一场通常横跨数十公里、涉及多个军或师的战役，压缩成约 14×10 格的营级战术切片。时间、主要地标、代表性参战部队、指挥体系、气候和装备按公开资料校准；单位数量、格距、单回合时长均属游戏抽象。

## 角色边界

- **高大全**是唯一虚构主角，担任“志愿军司令部直属加强营指挥员”，用于串联十二场关键战役；其跨战区调动是选集式叙事，并非真实番号履历。
- **常驻伴随将领**（郭恩志、胡修道、唐章洪、柴云振等）与各关**临时配属**均为真实志愿军人物；职务与简介按公开战史摘要，棋盘尺度仍是战术抽象。
- **敌军历史主将 / 精锐**会以精英单位出现在战场上（如金钟五、弗里曼、卡恩、特鲁多等），击溃后可缴获精英道具；不把军/兵团级主官做成完整可操作编制。
...
- U.S. Army Center of Military History, [The Korean War](https://history.army.mil/portals/143/Images/Publications/Publication%20By%20Title%20Images/K%20Pdf/CMH_Pub_19-5.pdf)
